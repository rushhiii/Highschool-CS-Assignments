...
public class GUI extends JPanel {
    ...
    private void addComponents() {
        ...
        ImageIcon icon = new ImageIcon("img/gui-icon.png"); // icon
        ...
        try {
            ...
            Font customFont1 = Font.createFont(Font.TRUETYPE_FONT, new File("fonts/Roboto-Bold.ttf"));
    ...
    private void repositionTextField() {
        ...
        // ! Not necessary because this.centerPanel is already a reference to
        // centerPanel
        // JPanel centerPanel = (JPanel) roundedTextField.getParent();

        centerPanel.remove(roundedTextField);
        centerPanel.add(roundedTextField, gbc);
        // ! Removed this line, which orphans the reference to roundedTextField and
        // replaces it with a new widget which is never used
        // roundedTextField = new RoundedJTextField(20);
    ...
    private void addRefreshButton(JPanel panel) {
        ImageIcon icon = new ImageIcon("img/refresh-icon.png"); // Replace with the actual path to the refresh icon
